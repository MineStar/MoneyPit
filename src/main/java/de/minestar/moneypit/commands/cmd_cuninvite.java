...
public class cmd_cuninvite extends AbstractExtendedCommand {
    ...
    public void execute(String[] args, Player player) {
        ...
        // send info
        PlayerUtils.sendMessage(player, ChatColor.DARK_AQUA, Core.NAME, "Click on a private protection to uninvite the following people:");
        String infoMessage = "";
        int i = 0;
        ...
        Core.playerManager.setState(player.getName(), PlayerState.PROTECTION_UNINVITE);
    }
}