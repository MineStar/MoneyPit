...
public class Module_ArmorStand extends Module {

    private final String NAME = "armorstand";

    public Module_ArmorStand(YamlConfiguration ymlFile) {
        this.writeDefaultConfig(NAME, ymlFile);
    }

    public Module_ArmorStand(ModuleManager moduleManager, YamlConfiguration ymlFile) {
        super();
        this.init(moduleManager, ymlFile, Material.ARMOR_STAND.getId(), NAME);
    }
